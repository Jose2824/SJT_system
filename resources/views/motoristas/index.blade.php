...
<head>
    ...
    <title>Motoristas - São José Transportes</title>
...
<body class="bg-white text-black">
    ...
    <header class="bg-[#0026FF] text-white shadow-md">
        <div class="max-w-7xl mx-auto flex items-center justify-between p-4">
            ...
            <nav class="space-x-6">
                ...
                <a href="{{ route('motoristas.create') }}" class="hover:text-[#BFC4C9] font-semibold">Cadastrar Motoristas</a>
    ...
    <main class="max-w-7xl mx-auto mt-10 px-6">
        <h2 class="text-3xl font-bold text-[#001C91] mb-6">Lista de Motoristas</h2>
        ...
        <div class="overflow-x-auto bg-[#BFC4C9]/30 rounded-2xl shadow-md">
            <table class="min-w-full border border-[#BFC4C9] text-left">
                ...
                <tbody>
                    @forelse ($motoristas as $index => $mt)
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="p-3 space-x-2">
                                ...
                                <form action="{{ route('motoristas.destroy', $mt->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-4 text-center text-gray-600">Nenhum motorista cadastrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
